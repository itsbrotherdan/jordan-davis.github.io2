...
//dogs.filter(animal => animal.species === 'dog');
...
// 5. 
var dogsWithClasses = dogContestants.map(function(animal){
    if (animal.weight >= 0 && animal.weight <= 10){
       animal.class = 'red'
    } if (animal.weight >= 11 && animal.weight <= 20){
       animal.class = 'yellow'
    } if (animal.weight >= 21){
       animal.class = 'green'
    }
